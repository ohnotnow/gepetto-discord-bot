...
from gepetto import replicate, weather, sentry, summary, images, gpt, response as gepetto_response
...
async def get_weather_forecast(discord_message, prompt, locations):
